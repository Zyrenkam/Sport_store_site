...
$vireo_theme_divider_style = array(
...
return array(
	'default_icon'                 => $vireo_theme_svg_icons['fort-awesome'],
	'icons'                        => $vireo_theme_svg_icons,
	'divider_style'                => $vireo_theme_divider_style,
	'lorem_ipsum'                  => $vireo_lorem_ipsum,
	'edit_this_text_in_customizer' => $vireo_theme_click_pen_to_edit_title,
	'gradients'                    => $vireo_gradients,
	...
	'front-header' => array(
		...
		'buttons'      => array(
			...
			'value' => array(
				array(
					'label'       => sprintf( $vireo_theme_action_button, 1 ),
					'url'         => '#',
					'button_type' => '0',
					'index'       => 0,
				),
				array(
					'label'       => sprintf( $vireo_theme_action_button_secondary, 1 ),
					'url'         => '#',
					'button_type' => '1',
					'index'       => 1,
				),
		...
		'title'        => array(
			'show'  => true,
			'value' => $vireo_theme_click_pen_to_edit_title,
			'style' => array(
				'descendants' => array(
					'text' => array(
						'textAlign' => 'center',
							...
							'image'     => array(
								array(
									'source'     => array(
										...
										'gradient' => $vireo_gradients['night_fade'],
									),
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $vireo_theme_svg_icons['facebook'],
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $vireo_theme_svg_icons['twitter-x'],
						'link_value' => '#',
						'index'      => 1,
					),
					array(
						'icon'       => $vireo_theme_svg_icons['youtube'],
						'link_value' => '#',
						'index'      => 2,
					),
					array(
						'icon'       => $vireo_theme_svg_icons['whatsapp-square'],
						'link_value' => '#',
						'index'      => 3,
					)
				),
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $vireo_theme_svg_icons['map-marker'],
						'text'       => '123, Main Street, City, Country',
						'link_value' => 'https://maps.google.com/',
						'index'      => 0,
					),
					array(
						'icon'       => $vireo_theme_svg_icons['phone'],
						'text'       => '+1 234 567 890',
						'link_value' => 'tel:+1 234 567 890',
						'index'      => 0,
					),
					array(
						'icon'       => $vireo_theme_svg_icons['envelope'],
	...
	'header'                            => array(
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $vireo_theme_svg_icons['map-pin'],
						'text'       => '1557 Frosty Lane, Binghamton, NY',
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $vireo_theme_svg_icons['phone-square'],
	...
	'blog_post_thumb_placeholder_color' => 'rgb(170,209,255)',
